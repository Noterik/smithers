...
public class CopyCommand implements Command {
	...
	public String execute(String uri, String xml) {	
		...
		// error message
		return FSXMLBuilder.getErrorMessage("500", "No input found", "Please call this command as follows: cp [OPTION] SOURCE DESTINATION", "http://teamelements.noterik.com/team");
	}
