...
/**
 * Action that puts certain rawaudios in a queue for transcoding
 *
 ...
 *
 */
public class WillieQueueAction extends ActionAdapter {
	/**
	 * logger
	 */
	private static Logger logger = Logger.getLogger(WillieQueueAction.class);
	
	/**
	 * queue uri
	 */
	private static final String QUEUE_URI = "/domain/{domainid}/service/willie/queue/{queueid}/job";
	
	/**
	 * queue overview uri
	 */
	private static final String QUEUE_OVERVIEW_URI = "/domain/{domainid}/service/willie/queue";
	...
	private void putInQueue() {
		...
		xml.append("<rawaudio id='1' referid='"+uri+"'/>");
		xml.append("</fsxml>");
